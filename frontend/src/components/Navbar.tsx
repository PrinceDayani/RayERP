...
export default function Navbar({ toggleSidebar, isMobile }: NavbarProps) {
  ...
  return (
    <header className="h-16 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 sm:px-6 shadow-sm sticky top-0 z-40">
      <div className="flex h-full items-center justify-between">
          ...
          <form onSubmit={handleSearch} className="hidden md:block">
            <div className="relative">
              ...
              <Input
                ...
                className="w-80 pl-10 bg-muted/50 border-0 focus:bg-background transition-colors"
              />
            </div>
          </form>
        </div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" className="md:hidden hover:bg-accent rounded-lg">
